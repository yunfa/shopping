...
public class SimpleAuthFilter extends AccessControlFilter {
	...
	private void logRequest(HttpServletRequest request) {
		...
		while (parameterNames.hasMoreElements()) {
			...
			sb.append(paran).append("=").append(request.getParameter(paran)).append("&");
		}
		logger.info("ip:{},userId:{},url:{}?{}", request.getRemoteAddr(), userName == null ? "" : userName,
				request.getRequestURL(), sb.toString());
	}
}

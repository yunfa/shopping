...
import com.alpha.common.utils.vcode.Captcha;
import com.alpha.common.utils.vcode.GifCaptcha;
import com.alpha.common.utils.vcode.SpecCaptcha;
...
public class CommonController extends BaseController {
    ...
    public ModelAndView _500(HttpServletRequest request) {
        ...
        if (null != stack && stack.length != 0) {
            ...
            logger.error("class:{},line:{},clazz:{},fileName:{},methodName:{}()", getClass(), line, clazz, fileName,
                    methodName);
        }
        return view;
    }
